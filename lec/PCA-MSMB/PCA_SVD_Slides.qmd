...
Measure multiple variables on the same subjects. E.g., for cohort of people: 
biometrical characteristics such as height, weight, BMI, age; 
as well as clinical variables such as blood pressure, blood sugar,  
heart rate. These variables will not be independent, we are interested in finding patterns between them.
