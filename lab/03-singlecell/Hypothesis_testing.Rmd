...
4. We want to quantify change in the abundance of the following populations with age: `MF-I`, `MF-II`, `MYH8+`, `MuSC`. Subset the data to these populations. Start by caculating number of cells of each type in every sample.  
